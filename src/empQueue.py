...
class EmpIOQueue:
    ...
    def __init__(self, async_, login):
        global empQueue
        empQueue = self
    ...
    def HandleInput(self):
        ...
        while 1:
            ...
            try:
                ...
                try:
                    tmp = self__socket__recv(4096).decode('latin-1', errors='replace')
                except socket.error as e:
...
##	pass
    ...
    def line(self, line):
        ...
        sp = line.find(' ')
        proto = line[:sp] if sp >= 0 else line.rstrip('\n')
        msg = line[sp+1:].rstrip('\n') if sp >= 0 else ""
...
class AsyncHandler:
    ...
    def line(self, line):
        ...
        if proto == C_DATA:
            ...
            viewer.Error("Server exiting (%s)." % (msg,))
...
##		empQueue.FLSentLev = empQueue.FLSentLev - 1
            ...
            empDb.megaDB['prompt']['inform'] = msg
            viewer.inform()
        elif proto == C_FLASH:
            viewer.flash(msg)
